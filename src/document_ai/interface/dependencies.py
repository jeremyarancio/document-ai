...
from document_ai.infrastructure.parser import DeepseekOCRParser
...
def get_db_service(
    ...
    return DuckDBService(
        ...
        figure_table_name=figure_table_name,
        markdown_table_name=markdown_table_name,
        page_table_name=page_table_name,
    )


def get_parser() -> IParserService:
    return DeepseekOCRParser()
